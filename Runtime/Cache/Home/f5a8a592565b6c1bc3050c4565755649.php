...
<body>
<div class="title text-center"><a href="<?php echo U('user/member');?>" class="title-left"><img class="back-btn" src="/Public/Home/img/left.png" width="10" alt=""></a>堂食<a href="#" class="title-right"></a></div>
...
<a href="<?php echo U('order/detail',array('order_id'=>$vo['order_id']));?>">
    <div class="hall_list_l pull-left"><img src="<?php echo (get_cover($vo["pic"],path)); ?>" alt=""></div>
  <div class="hall_list_r pull-left"><p><?php echo ($vo["name"]); ?></p><p><?php echo (date('Y-m-d h:m:s',$vo["create_time"])); ?></p><p class="status orange"><?php echo (getorderstatus($vo["status"])); ?></p></div>
